        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Buses_busInfoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Invoices_Buses_busInfoId",
                        column: x => x.busInfoId,
                        principalTable: "Buses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Fair = table.Column<decimal>(type: "decimal(18,6)", nullable: true),
                    OrginTime = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_busRoutes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_busRoutes_Buses_BusInfoId",
                        column: x => x.BusInfoId,
                        principalTable: "Buses",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_busRoutes_Cities_DestinationId",
                        column: x => x.DestinationId,
                        principalTable: "Cities",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_busRoutes_Cities_OriginId",
                        column: x => x.OriginId,
                        principalTable: "Cities",
                        principalColumn: "Id");
                });
